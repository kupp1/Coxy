...
class Irc():
                    ...
                    if msgs:
                        for msg in msgs.split('\r\n'):
                            if msg:
                                ...
                                if re.search('^(00[1-9]|372)$', Parse(msg).command):  # если пришло
    ...
    def _cut(self, command: str, recipient: str, text: str, start: int, end: int):
        r"""Разделяет блинное сообщение на части, т.к. в irc privmsg не может веcить больше 512 байт (514: два на \r\n)"""
