...
class Commands():
    ...
    def tg(irc: IrcClient, recipient: str):
    irc.send_privmsg(recipient, 'https://t.me/sixteen_bits')

    def steam(irc: IrcClient, recipient: str):
        irc.send_privmsg(recipient, 'https://steamcommunity.com/groups/BochaClub')
